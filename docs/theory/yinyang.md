...
description: 系统讲解阴阳理论的核心概念、平衡关系、转化逻辑及其在命理判断中的基础作用，适合作为八字、紫微斗数与六爻学习的理论基础。
...
阴阳不是只用来解释“相反的两面”，而是整个命理判断里最底层的分类与动态框架。无论是八字里的寒热燥湿、紫微里的动静内外，还是周易里的刚柔进退，背后都离不开阴阳的平衡、消长与转化逻辑。

如果你之前觉得阴阳理论太抽象，可以把这页当作所有术数模块的共同底层说明书：先理解为什么要这样分，再回头看具体体系，很多判断顺序会更清楚。
