---
layout: default
title: 周易六爻先学什么：八卦、装卦、断卦与案例学习中心
seo_title: 周易六爻先学什么：八卦、装卦、断卦与案例学习中心
description: 系统整理周易八卦、六爻占卜、纳甲装卦、断卦规则、分类占断与应期判断的学习顺序，适合先理清周易六爻的阅读路线，再继续深读。
keywords: [ 周易, 六爻, 八卦, 易经, 卦象, 预测学, 中国哲学, 六十四卦 ]
author: 周易研究团队
date: 2025-11-06
cta_heading: 想先走一遍主站周易学习路线？直接去六爻指南
cta_description: 这页负责整理八卦、断卦、应期和案例的完整路径；如果你想先从主站快速进入周易六爻学习主线，再回头按索引深读，六爻指南更适合先入门。
...
# 周易六爻先学什么：八卦、装卦、断卦与案例学习中心

如果你主要是为了学六爻实战，建议把这条路线记住：八卦基础 → 起卦方法 → 纳甲装卦 → 类象落地 → 断卦规则 → 分类占断 → 应期训练。很多人学到中段会卡住，不是因为规则不够，而是不会把六亲、六神、世应和伏神真正落到现实事件里。

如果你想先快速判断“周易和六爻应该从哪里开始学”，可以先去 [主站六爻指南](https://tianjiyao.com/zh/liuyao-guide) 看起卦、装卦和判断主线，再回来按这页安排完整阅读顺序；如果你已经准备带着具体问题进入实践，也可以直接去 [主站周易起卦入口](https://tianjiyao.com/zh/zhouyi-divination)。
...
六爻最适合带着具体问题进入真实判断。先在站内把装卦、取用神、分类占断与应期顺序走清，再到主站起卦，会比一开始直接问更稳。

### 站内优先阅读

- [六爻断卦核心法则](duan-gua-rules.md) - 先把取用神和判断顺序固定下来
