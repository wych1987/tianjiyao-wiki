...
- **162 篇已发布知识页**，覆盖入门、专题、FAQ、命例与方法论页面
- **6 大知识模块**：八字 24 篇、紫微 32 篇、周易 24 篇、AI 24 篇、理论 16 篇、实践 41 篇
- **三层导航结构**：首页总览、模块首页、专题导航与命例索引
- **双站分工明确**：Wiki 负责知识体系与学习路径，主站负责排盘、占断与真实场景验证
...
建议先在八字或紫微中选择一个主体系入门，再回到理论基础补阴阳五行与干支框架，之后通过实践区的学习地图、命例库和专题导航完成交叉训练。等基础稳定后，再进入周易六爻或 AI 模块扩展视角。
